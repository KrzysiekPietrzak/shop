                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('products.store') }}">
                        ...
                        <div class="row mb-3">
                           ...
                           <div class="col-md-6">
                                <textarea id="description" type="text" class="form-control" maxlength="1500" @error('description') is-invalid @enderror" name="description" value="{{ old('description') }}"  autofocus> </textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="number" step="0.01" default="1" min="0" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" autocomplete="price">
